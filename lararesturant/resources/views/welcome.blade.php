...
<section id="about" class="about">
    <img src="{{ asset('frontend/images/icons/leter-a-inside-a-black-circle.png') }}" class="img-responsive section-icon hidden-sm hidden-xs">
    <div class="wrapper">
            ...
            <div class="container-fluid color-bg">
                <div class="row dis-table">
                    ...
                    <div class="col-xs-6 col-sm-6 dis-table-cell">
                        <div class="section-content">
                            <p> Prince Plaza(4th floar) Dhaka</p>
                            <p>+44 12 213584</p>
                            <p>taslima@mail.com </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, {{ date('Y') }} <a href="#">Taslima's Kitchen.</a> <strong> Developed &amp; <i class="far fa-heart"></i> by  Mst.Taslima Khatun </strong>
